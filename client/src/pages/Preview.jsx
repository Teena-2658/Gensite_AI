...
//           <button className="hidden md:flex items-center gap-2 px-3 py-1.5 text-zinc-600 hover:bg-zinc-100 rounded-lg text-xs font-semibold">
//             <ExternalLink size={14} /> Share
//           </button>
//           <button className="bg-zinc-900 text-white px-4 py-1.5 rounded-lg text-xs font-bold hover:bg-black transition-colors shadow-sm">
//             Publish
//           </button>
//         </div>
//       </header>
